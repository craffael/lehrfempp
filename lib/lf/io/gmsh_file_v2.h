...
/**
 * @brief Make lf::io::GMshFileV2 formattable by fmt (https://fmt.dev/latest/api.html#ostream-api)
 */
template <> struct fmt::formatter<lf::io::GMshFileV2> : ostream_formatter{};

/**
 * @brief Make f::io::GMshFileV2::ElementType formattable by fmt (https://fmt.dev/latest/api.html#ostream-api)
 */
template <> struct fmt::formatter<lf::io::GMshFileV2::ElementType> : ostream_formatter{};
