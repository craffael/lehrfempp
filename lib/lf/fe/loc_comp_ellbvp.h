 ...
 LagrangeFEEllBVPElementMatrix<DIFF_COEFF, REACTION_COEFF>::Eval(
   ...
   switch (ref_el) {
     case lf::base::RefEl::kTria(): {
       ...
       // Element matrix
       ElemMat mat(Nrsf_tria_, Nrsf_tria_);
       mat.setZero();
     ...
     case lf::base::RefEl::kQuad(): {
       ...
       // Element matrix
       ElemMat mat(Nrsf_quad_, Nrsf_quad_);
       mat.setZero();
