...
struct OperatorAddition {
  ...
  template <
      class S1, int R1, int C1, int O1, int MR1, int MC1, class S2, int R2,
      int C2, int O2, int MR2, int MC2,
      class = std::enable_if_t<R1 != Eigen::Dynamic && C1 != Eigen::Dynamic &&
...
struct OperatorSubtraction {
  ...
  // subtraction of static sized eigen matrices
  template <
      class S1, int R1, int C1, int O1, int MR1, int MC1, class S2, int R2,
      int C2, int O2, int MR2, int MC2,
      class = std::enable_if_t<R1 != Eigen::Dynamic && C1 != Eigen::Dynamic &&
