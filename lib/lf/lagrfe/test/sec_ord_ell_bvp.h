 ...
 * - lf::lagrfe::SecOrdBVPLagrFEFullInteriorGalMat()
 * - lf::lagrfe::SecOrdBVPLagrFEBoundaryGalMat()
 * - lf::lagrfe::LagrFEVolumeRightHandSideVector()
 * - lf::lagrfe::LagrFEBoundaryRightHandSideVector()
 */
template <typename SCALAR>
