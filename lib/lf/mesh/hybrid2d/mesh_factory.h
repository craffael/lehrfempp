...
/**
 * @brief Make lf::mesh::hybrid2d::MeshFactory formattable by fmt (https://fmt.dev/latest/api.html#ostream-api)
 */
template <> struct fmt::formatter<lf::mesh::hybrid2d::MeshFactory> : ostream_formatter{};
