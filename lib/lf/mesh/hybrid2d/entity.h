...
class Node : public mesh::Entity {
 ...
 public:
   ...
   */
  explicit Node(size_type index, std::unique_ptr<geometry::Geometry>&& geometry)
...
class Edge : public mesh::Entity {
 ...
 public:
   ...
   * entity before you can initialize the entity object itseld.
   */
  explicit Edge(size_type index, std::unique_ptr<geometry::Geometry>&& geometry,
 ...
 private:
  size_type index_ = -1;  // zero-based index of this entity.
  std::unique_ptr<geometry::Geometry> geometry_;  // shape information
  std::array<const Node*, 2> nodes_;              // nodes connected by edge
};
...
class Trilateral : public mesh::Entity {
 ...
 public:
  ...
  explicit Trilateral(size_type index,
                      ...
                      const Node* corner2, const Edge* edge0, const Edge* edge1,
                      const Edge* edge2)
      : index_(index),
        geometry_(std::move(geometry)),
 ...
 private:
  size_type index_ = -1;  // zero-based index of this entity.
  std::unique_ptr<geometry::Geometry> geometry_;  // shape information
  std::array<const Node*, 3> nodes_;              // nodes = corners of cell
...
class Quadrilateral : public mesh::Entity {
 ...
 private:
  size_type index_ = -1;  // zero-based index of this entity.
  std::unique_ptr<geometry::Geometry> geometry_;  // shape information
  std::array<const Node*, 4> nodes_;              // nodes = corners of quad
