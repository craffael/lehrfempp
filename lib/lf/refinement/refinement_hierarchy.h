...
namespace lf::refinement {
  ...
  struct ParentInfo {
    explicit ParentInfo(void):
      parent_ptr_(nullptr),child_number_(-1) {}
    // Data members
    mesh::Entity *parent_ptr_; /**< parent entity, not necessarily the same type */
  ...
  public:
    ...
    /**
     * @brief Perform regular uniform refinement of the finest mesh in the hierarchy
     *
     ...
     */
    template <typename Marker> void MarkEdges(Marker &&marker);
    /** 
