...
namespace lf::refinement {
  ...
  lf::base::size_type
  Hybrid2DRefinementPattern::noChildren(lf::base::dim_t codim) const {
	...
	switch (ref_pat_) {
	case RefPat::rp_nil: { return 0; }
	case RefPat::rp_copy: { return 0; }
	case RefPat::rp_split: { return 1; }
	default: {
	  LF_VERIFY_MSG(false,"refinement pattern " << (int)ref_pat_
			<< "not implemented for edge!");
	  break;
	...
	case RefPat::rp_nil: { return 0; }
	case RefPat::rp_copy: { return 1; }
	case RefPat::rp_bisect: { return 2; } 
	case RefPat::rp_trisect: { return 3; }
	case RefPat::rp_trisect_left: { return 3; }
	case RefPat::rp_quadsect: { return 4; }
	case RefPat::rp_regular: { return 4; } 
	case RefPat::rp_barycentric: { return 6; }
	default: {
	  LF_VERIFY_MSG(false,"refinement pattern " << (int)ref_pat_
	...
	case RefPat::rp_nil: { return 0; }
	case RefPat::rp_copy: { return 0; }
	case RefPat::rp_bisect: { return 1; } 
	case RefPat::rp_trisect: { return 2; }
	case RefPat::rp_trisect_left: { return 2; }
	case RefPat::rp_quadsect: { return 3; }
	case RefPat::rp_regular: { return 3; } 
	case RefPat::rp_barycentric: { return 6; }
	default: {
	  LF_VERIFY_MSG(false,"refinement pattern " << (int)ref_pat_
			<< "not implemented for triangle!");
	...
	break;
      ...
      case 2: {
	if (ref_pat_ == RefPat::rp_barycentric) return 1;
	else return 0;
	break;
      }
      } // end switch codim 
	...
	case RefPat::rp_split: { return 2; }
	case RefPat::rp_threeedge: { return 4; } 
	...
	case RefPat::rp_bisect: 
	case RefPat::rp_split: { return 1; }
	case RefPat::rp_threeedge: { return 3; } 
	case RefPat::rp_barycentric: 
	case RefPat::rp_regular: { return 4; }
	default: {
	  LF_VERIFY_MSG(false,"refinement pattern " << (int)ref_pat_
  ...
  Hybrid2DRefinementPattern::ChildPolygons(lf::base::dim_t codim) const {
	...
	// Different layout of interior edges for different refinement patterns
	switch (ref_pat_) {
	case RefPat::rp_nil: 
	case RefPat::rp_copy: {
