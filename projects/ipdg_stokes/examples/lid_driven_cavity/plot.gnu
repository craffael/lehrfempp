...
set output 'convergence_l2_weighted.pdf'
set title 'L2 convergence'
plot 'output.dat' using 2:4 with lines title 'Weighted L2 error', \
     x**(-0.5) title 'N^{-1/2}' dt 2

set output 'convergence_dg.pdf'
set title 'DG-norm convergence'
plot 'output.dat' using 2:5 with lines title 'DG-norm error'


set output 'convergence_l2_modified.pdf'
set title 'L2 convergence'
plot 'output.dat' using 2:6 with lines title 'L2 error', \
     x**(-0.5) title 'N^{-1/2}' dt 2

set output 'convergence_l2_weighted_modified.pdf'
set title 'L2 convergence'
plot 'output.dat' using 2:7 with lines title 'Weighted L2 error', \
     x**(-0.5) title 'N^{-1/2}' dt 2
