/**
 * @file
 * @brief local and global tests for the implementation of quadratic
...
TEST(FeLagrO2, scal_fe_coeff_node) {
  std::cout << ">>> O2 FE: Test of consistency of nodal interpolation \n";
...
TEST(FeLagrO2, scal_fe_val_node) {
  std::cout << ">>> O2 FE: Test of consistency of nodal interpolation \n";
...
TEST(FeLagrO2, shape_function_information) {
  std::cout << ">>> O2 Fe: Test of number of reference shape functions \n";
...
TEST(FeLagrO2, shape_function_cardinality) {
  std::cout << ">>> O2 Fe: Test of cardinal basis property of reference shape "
               "functions \n";
...
TEST(FeLagrO2, shape_function_gradient_sum) {
  std::cout << ">>> O2 Fe: Test of gadients summing up to 0 \n";
...
// lehrfem test for the ReactionDiffusionElementMatrixProvider
// here used to test if the computation of the gradients etc. in the
// reference finite element are correct:
TEST(FeLagrO2, mass_mat_test) {
  std::cout << " >>> O2 FE: Test of computation of element matrices \n";
...
TEST(FeLagrO2, a_dir_dbg_1) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 1, constant reference function"
            << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_2) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 2, linear reference function"
            << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_3) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 3, linear reference function"
            << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_4) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 4, linear reference function"
            << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_5) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 5, linear reference function"
            << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_6) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 6, f = e^(x*y)" << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_7) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 7, f = e^(x*y)" << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_8) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 8, f = e^(x*y)" << std::endl;
...
TEST(FeLagrO2, a_dir_dbg_9) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Bilinear form test 9, linear f" << std::endl;
...
TEST(FeLagrO2, bd_a_1) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Boundary energy test 1, linear f" << std::endl;
...
TEST(FeLagrO2, bd_a_2) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << ">>> O2 FE: Boundary energy test 2, linear f" << std::endl;
...
TEST(FeLagrO2, bd_a_3) {
  // Four levels of refinement
  const int reflevels = REFLEV;
  std::cout << "O2 FE: Boundary energy test 3, f = exp(x*y)" << std::endl;
