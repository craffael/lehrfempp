/**
  @file
 * @headerfile projects/convergence_studies/primal_dpg.h
...
#ifndef PROJECTS_DPG_CS_PRIMAL_DPG_H
...
//[number of dofs, H1-error, error estimator].
...
#endif  // PROJECTS_DPG_CS_PRIMAL_DPG_H
