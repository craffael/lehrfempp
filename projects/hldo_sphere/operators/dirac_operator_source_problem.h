#ifndef THESIS_OPERATORS_DIRAC_OPERATOR_SOURCE_PROBLEM_H
#define THESIS_OPERATORS_DIRAC_OPERATOR_SOURCE_PROBLEM_H
...
#endif  // THESIS_OPERATORS_DIRAC_OPERATOR_SOURCE_PROBLEM_H
