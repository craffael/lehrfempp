#ifndef HLDO_SPHERE_OPERATORS_WHITNEY_TWO_HODGE_LAPLACE_H
#define HLDO_SPHERE_OPERATORS_WHITNEY_TWO_HODGE_LAPLACE_H
...
#endif  // HLDO_SPHERE_OPERATORS_WHITNEY_TWO_HODGE_LAPLACE_H
