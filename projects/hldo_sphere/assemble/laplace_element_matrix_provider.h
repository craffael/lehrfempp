#ifndef THESIS_ASSEMBLE_LAPLACE_ELEMENT_MATRIX_PROVIDER_H
#define THESIS_ASSEMBLE_LAPLACE_ELEMENT_MATRIX_PROVIDER_H

/**
 * @file laplace_element_matrix_provider.h
 * @brief An element matrix provider for vector valued piecewise linear basis
 * functions and the bilinear form
 * @f[
 * \int_{\Omega} grad_{\Gamma}(u) grad_{\Gamma}(v) dx
 * @f]
 */
 ...
 *
 */
class LaplaceElementMatrixProvider {
 public:
  /**
   * @brief Constructor
   */
  LaplaceElementMatrixProvider(){};
