#ifndef HLDO_SPHERE_ASSEMBLE_LAPLACE_MATRIX_PROVIDER_H
#define HLDO_SPHERE_ASSEMBLE_LAPLACE_MATRIX_PROVIDER_H
 ...
 * @f[
 * (u,v) \mapsto \int\limits_{K} \mathbf{grad}_{\Gamma}(u) \cdot
