#ifndef HLDO_SPHERE_ASSEMBLE_WHITNEY_TWO_MASS_MATRIX_PROVIDER_H
#define HLDO_SPHERE_ASSEMBLE_WHITNEY_TWO_MASS_MATRIX_PROVIDER_H
...
#endif  // HLDO_SPHERE_ASSEMBLE_WHITNEY_TWO_MASS_MATRIX_PROVIDER_H
