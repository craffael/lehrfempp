...
int main(int /*argc*/, char ** /*argv*/){
  ...
  Eigen::VectorXd mu1_ipol(39); mu1_ipol.setZero();
  Eigen::VectorXd mu2_ipol(125); mu2_ipol.setZero();
  Eigen::VectorXd mu3_ipol(444); mu3_ipol.setZero();
  Eigen::VectorXd mu4_ipol(1670); mu4_ipol.setZero();
